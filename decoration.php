...
<body id="page-top">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll" href="#page-top">F.R.I.E.N.D.S Wedding Planne</a>
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="intro-title mb-4">Select Decoration</h1>
          <p class="intro-subtitle"><span class="text-slider-items">SCROLL DOWN</span><strong class="text-slider"></strong></p>

   ...
   <section id="work" class="portfolio-mf sect-pt4 route">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="work-box">
            <a href="img/img2.jpeg" data-lightbox="gallery-mf">
              <div class="work-img">
                <img src="img/img2.jpeg" alt="" class="img-fluid">
              </div>
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
        ...
        <div class="col-md-4">
          <div class="work-box">
            <a href="img/img3.jpeg" data-lightbox="gallery-mf">
              <div class="work-img">
                <img src="img/img3.jpeg" alt="" class="img-fluid">
              </div>
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
        ...
        <div class="col-md-4">
          <div class="work-box">
            <a href="img/img4.jpeg" data-lightbox="gallery-mf">
              <div class="work-img">
                <img src="img/img4.jpeg" alt="" class="img-fluid">
              </div>
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
        ...
        <div class="col-md-4">
          <div class="work-box">
            <a href="img/img5.jpeg" data-lightbox="gallery-mf">
              <div class="work-img">
                <img src="img/img5.jpeg" alt="" class="img-fluid">
              </div>
              <div class="work-content">
                <div class="row">
                 <div class="col-sm-8">
        ...
        <div class="col-md-4">
          <div class="work-box">
            <a href="img/img6.jpeg" data-lightbox="gallery-mf">
              <div class="work-img">
                <img src="img/img6.jpeg" alt="" class="img-fluid">
              </div>
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">

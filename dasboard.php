...
<h2 class="text-center mt-5">Wedding Service ID</h2>
 <?php
        ?>
        <div class="container mt-4">
            <div class="card">
                <div class="card-header bg-info">
                    <div class="row">
                        ...
                        <div class="col-md-2">C-ID</div>
                        <div class="col-md-2">D-ID</div>
                        <div class="col-md-2">T-ID</div>
                        <div class="col-md-2">P-ID</div>
                    </div>
                </div>
                <div class="card-body">
                    <?php
                   ...
                   $run=mysqli_query($con,$sql);
                    while ($row = mysqli_fetch_array($run)) {
                        ...
                        ?>
                        <div class='row'>
                            <div class='col-md-2'><h5><?php echo $vid; ?></h5></div>
                            <div class='col-md-2'><h5><?php echo $mid; ?></h5></div>
                            <div class='col-md-2'><h5><?php echo $cid; ?></h5></div>
                            <div class='col-md-2'><h5><?php echo $did; ?></h5></div>
                            <div class='col-md-2'><h5><?php echo $tid; ?></h5></div>
                            <div class='col-md-2'><h5><?php echo $pid; ?></h5></div>
                        </div>
                        <br>
                        <?php
                    }
 ...
 <h2 class="text-center">Wedding Details</h2>
  <br>
   ...
   <h2 class="text-center mt-5">Check Booking</h2>
